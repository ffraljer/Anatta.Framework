...
internal static class AnattaShaderCompiler {
    internal static byte[] CompileGlslToSpirv(string glsl, ShaderKind kind) {
    ...
    internal static unsafe string SpirvToHlsl(byte[] spirv) {
        ...
        SpirvCrossApi.spvc_context_parse_spirv(ctx, spirv, out var ir);
        ...
        var hlsl = Marshal.PtrToStringUTF8((IntPtr)result)!;
    ...
    InputElementDescription[] Layout
        ...
        uint byteOffset = 0;
        foreach (var (loc, baseTypeId, _) in inputs) {
        ...
        spvc_reflected_resource* uboList = null;
        nuint uboCount = 0;
        SpirvCrossApi.spvc_resources_get_resource_list_for_type(
            resources2,
